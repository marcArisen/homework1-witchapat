...
class TestMachines(unittest.TestCase):
    base_url = "http://127.0.0.1:6969" # TOFIX: hardcode
    ...
    def test_get_machine_by_id(self):
        ...
        assert response_json["location"] != None
        assert response_json["stock"] != None
    ...
    def test_get_all_machines(self):
        ...
        for machine in response_json:
            assert machine["id"] != None
            assert machine["name"] != None
            assert machine["location"] != None
            assert machine["stock"] != None
